  ...
  return (
    <>
      ...
      <div className='mt-10'>
        ...
        <div className='grid sm:grid-cols-2 gap-y-10 lg:grid-cols-3 justify-items-center'>
          ...
          <a href="https://www.linkedin.com/in/m%C3%A1ximo-sebastian-donza-875379301/"><i className="flex items-center justify-center w-16 h-16 text-4xl rounded-full fa-brands fa-linkedin dark:hover:bg-blanco dark:hover:text-negro hover:bg-blue-400 hover:text-blanco"></i></a>
      ...
      <div>
        ...
        <div className='grid sm:grid-cols-2 gap-y-20 lg:grid-cols-3 justify-items-center'>
          ...
          <a className='w-36 h-36' href="https://www.linkedin.com/in/carlos-andr%C3%A9s-di-cicco-8046225/"><img className='aspect-auto	rounded-full w-36 h-36' src={user} alt="Carlos Di cicco" /></a>
        </div>
      </div>
